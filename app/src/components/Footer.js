        ...
        <footer>
            ...
            <ul className="links" >
                ...
                <li className="nav-item">
                    <a href="https://twitter.com/will_ferens" target="_blank">
                ...
                <li className="nav-item">
                    <a href="https://github.com/will-ferens" target="_blank"><svg width="17" height="17" viewBox="0 0 1024 1024">
                    <path d={ICONS.GITHUB}></path>
                    </svg></a>
                </li>
                <li className="nav-item">
                    <a href="https://www.linkedin.com/in/will-ferens/" target="_blank">
